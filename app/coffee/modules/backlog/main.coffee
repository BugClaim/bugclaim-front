...
class BacklogController extends mixOf(taiga.Controller, taiga.PageMixin, taiga.FiltersMixin, taiga.UsFiltersMixin)
    ...
    loadUserstories: (resetPagination = false, pageSize) ->
        ...
        return promise.then (result) =>
            ...
            if header('Bugclaim-Info-Backlog-Total-Userstories')
                @.totalUserStories = header('Bugclaim-Info-Backlog-Total-Userstories')

            if header('Bugclaim-Info-Userstories-Without-Swimlane')
                @scope.noSwimlaneUserStories = header('Bugclaim-Info-Userstories-Without-Swimlane')
